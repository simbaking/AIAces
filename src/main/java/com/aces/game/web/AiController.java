...
public class AiController {
    ...
    @GetMapping("/ai/remote-status")
    public Map<String, Object> getRemoteStatus() {
        return com.aces.game.ai.TrainingClient.getInstance().getRemoteStatus();
    }

    @PostMapping("/ai/start-training")
    public Map<String, Object> startTraining() {
        backgroundTrainer.start();
        Map<String, Object> response = new HashMap<>();
        response.put("success", true);
        response.put("message", "Background training started.");
        return response;
    }

    @PostMapping("/ai/stop-training")
    public Map<String, Object> stopTraining() {
        backgroundTrainer.stop();
        Map<String, Object> response = new HashMap<>();
        response.put("success", true);
        response.put("message", "Background training stopped.");
        return response;
    }
